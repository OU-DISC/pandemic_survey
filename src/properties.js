 ...
 * @type {string}
 */
var title = 'Pandemic Visualization Literature';
 ...
 */
var paper = {
    html: 'Literature collection on <b>pandemic visualization</b>. Keywords merge Survey I–III classifications (data, users, charts, interaction/tools, visualization levels, tasks).',
    id: ''
};
